<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Exam_1027.Login" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Home.aspx">帳戶頁面</asp:HyperLink>
